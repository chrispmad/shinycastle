...
auth_ui_custom <- function(id, status = "primary", tags_top = NULL,
  ...
  # shiny::includeHTML('../fun_login/www/boring_login.html')
  # uiOutput(ns('rendered_output'))
  html_file <- readLines("inst/assets/castle_gate.html", warn = FALSE)
  # html_file <- readLines("inst/assets/boring_login.html", warn = FALSE)
  ...
  #                          column(4,
  #                                 tags$div(
  #                                   style = "text-align: left; font-size: px;",
  #                                   selectInput(
  #                                     inputId = ns("language"),
  #                                     label = NULL,
  #                                     choices = choices,
